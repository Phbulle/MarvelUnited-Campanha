      ...
      <div className="glass-panel" style={{ padding: '40px', width: '100%', maxWidth: '400px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
        ...
        <form onSubmit={handleAuth} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          <button 
            ...
            style={{ justifyContent: 'center', marginTop: '8px', fontSize: '1rem', padding: '12px' }}
            disabled={loading}
          >
        ...
        <button 
          type="button" 
          className="tool-btn" 
          style={{ justifyContent: 'center', fontSize: '1rem', padding: '12px', background: 'var(--glass-bg)', border: '1px solid var(--glass-border)', color: 'var(--text-primary)' }}
